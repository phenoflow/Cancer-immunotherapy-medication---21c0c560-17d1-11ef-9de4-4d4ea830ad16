...
steps:
  ...
  cancer-immunotherapy-medication-syringe---primary:
    run: cancer-immunotherapy-medication-syringe---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-immunotherapy-medication-denosumab---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-immunotherapy-medication-syringe---primary/output
  output-cases:
